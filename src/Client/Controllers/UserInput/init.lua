...
function UserInput:GetPreferred() 
	...
	for touchType, num in pairs(self.Preferred) do 
		if num == _pref then 
			return touchType 
		end 
	end 
...
function UserInput:isTouch()
	return userInputService.GamepadEnabled == false and userInputService.KeyboardEnabled == false and userInputService.TouchEnabled
end 

function UserInput:hasMouse()
	return userInputService.MouseEnabled 
end 

function UserInput:hasKeyboard()
