...
local function canOcclude(part)
	...
	if part:GetAttribute("IgnoreOcclusion") then 
		return false 
	end 

	return 
		
		part:GetAttribute("Occlude") 
...
local function getCollisionPoint(origin, dir)
	...
	repeat
		...
		if hitPart then --and not hitPart:GetAttribute("IgnoreOcclusion") then
			if hitPart.CanCollide then--or hitPart:GetAttribute("Occlude") then
